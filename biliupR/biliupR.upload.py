...
if os_type == "Windows":
    ...
    download_and_run_script('https://github.com/ikun1993/biliupstart/releases/latest/download/biliupR_upload.bat')
elif os_type in ["Linux", "Darwin"]:
    # Linux or Mac
    print("你是Linux系统 正在下载对应脚本")
    download_and_run_script('https://github.com/ikun1993/biliupstart/releases/latest/download/biliupR_upload.sh')
else:
