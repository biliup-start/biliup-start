...
LOG_FILE="/opt/DanmakuRender/logs/script-df-`date +"%Y-%m"`.log"    
REC_DIR1="/opt/DanmakuRender/直播回放"  
REC_DIR2="/opt/DanmakuRender/直播回放（带弹幕版）"  
command="find / -type f -mtime 1 \( -name "*.mp4" -o -name "*.fiv" \) -delete"  
